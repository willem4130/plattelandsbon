...
export function VoucherDetailContent({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-green-50/30 to-amber-50/20">
        ...
        <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4">
          ...
          <Link href="/bonnen" className="flex items-center gap-2 text-sm text-primary hover:underline">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-green-50/30 to-amber-50/20">
      ...
      <main className="container mx-auto max-w-2xl px-4 py-12">
        {/* Back link */}
        <Link href="/bonnen" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors mb-8">
          <ArrowLeft className="h-4 w-4" />
          Alle bonnen
        </Link>
